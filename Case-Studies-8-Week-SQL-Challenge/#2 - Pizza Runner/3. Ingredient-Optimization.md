...
- Calculates total usage of each topping across all delivered pizzas
- Includes base recipe count, extras added, and exclusions removed
- Helps optimize inventory, spot customization trends, and inform menu decisions
- Output ranks toppings by real-world usage for better supply planning
